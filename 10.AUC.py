...
y_pred_proba_traditional = best_traditional_model.predict_proba(X_test)[:,1]
...
fpr_t_p, tpr_t_p, thresholds_t_p = roc_curve(y_t_p_test, y_pred_proba)
...
plt.tight_layout()
plt.savefig('10.roc_curve_comparison.pdf', dpi=300)
plt.close()
